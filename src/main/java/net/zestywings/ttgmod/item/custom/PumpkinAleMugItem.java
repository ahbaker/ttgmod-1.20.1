...
public class PumpkinAleMugItem extends Item {
    private static final int MAX_USE_TIME = 40;

    public PumpkinAleMugItem(Settings settings) {
        super(settings);
    }
    ...
    public ItemStack finishUsing(ItemStack stack, World world, LivingEntity user) {
        ...
        if (!world.isClient) {
            user.addStatusEffect(new StatusEffectInstance(ModEffects.HEAD_CURSE, 24000));
