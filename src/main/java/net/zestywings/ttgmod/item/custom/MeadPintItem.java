...
public class MeadPintItem extends Item {
    private static final int MAX_USE_TIME = 40;

    public MeadPintItem(Settings settings) {
        super(settings);
    }
    ...
    public ItemStack finishUsing(ItemStack stack, World world, LivingEntity user) {
        ...
        if (!world.isClient) {
            user.addStatusEffect(new StatusEffectInstance(ModEffects.PHOTOSYNTHETIC, 3600));
