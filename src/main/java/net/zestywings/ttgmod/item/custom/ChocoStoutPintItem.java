...
public class ChocoStoutPintItem extends Item {
    private static final int MAX_USE_TIME = 40;

    public ChocoStoutPintItem(Settings settings) {
        super(settings);
    }
    ...
    public ItemStack finishUsing(ItemStack stack, World world, LivingEntity user) {
        ...
        if (!world.isClient) {
            user.addStatusEffect(new StatusEffectInstance(ModEffects.STOUT, 3600));
