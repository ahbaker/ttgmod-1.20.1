...
public class ChorusLagerPintItem extends Item {
    private static final int MAX_USE_TIME = 40;

    public ChorusLagerPintItem(Settings settings) {
        super(settings);
    }
    ...
    public ItemStack finishUsing(ItemStack stack, World world, LivingEntity user) {
        ...
        if (!world.isClient) {
            user.addStatusEffect(new StatusEffectInstance(ModEffects.CHORUSCOUNTDOWN, 3600));
