...
public class IndiaPaleAlePintItem extends Item {
    private static final int MAX_USE_TIME = 40;

    public IndiaPaleAlePintItem(Settings settings) {
        super(settings);
    }
    ...
    public ItemStack finishUsing(ItemStack stack, World world, LivingEntity user) {
        ...
        if (!world.isClient) {
            user.addStatusEffect(new StatusEffectInstance(ModEffects.HUNGRYHEARTS, 3600));
