...
public class MushroomAlePintItem extends Item {
    private static final int MAX_USE_TIME = 40;

    public MushroomAlePintItem(Settings settings) {
        super(settings);
    }
    ...
    public ItemStack finishUsing(ItemStack stack, World world, LivingEntity user) {
        ...
        if (!world.isClient) {
            user.addStatusEffect(new StatusEffectInstance(ModEffects.SHROOMBOOST, 3600));
