...
public class PumpkinAlePintItem extends Item {
    private static final int MAX_USE_TIME = 40;

    public PumpkinAlePintItem(Settings settings) {
        super(settings);
    }
    ...
    public ItemStack finishUsing(ItemStack stack, World world, LivingEntity user) {
        ...
        if (!world.isClient) {
            user.addStatusEffect(new StatusEffectInstance(ModEffects.LOWGRAV, 24000));
