...
public class FloralPilsnerMugItem extends Item {
    private static final int MAX_USE_TIME = 40;

    public FloralPilsnerMugItem(Settings settings) {
        super(settings);
    }
    ...
    public ItemStack finishUsing(ItemStack stack, World world, LivingEntity user) {
        ...
        if (!world.isClient) {
            user.addStatusEffect(new StatusEffectInstance(ModEffects.FLORAL, 1,1));
