...
public interface ImplementedInventory extends SidedInventory {
     ...
     */
    static net.zestywings.ttgmod.item.inventory.ImplementedInventory of(DefaultedList<ItemStack> items) {
        return () -> items;
    }
     ...
     * @return a new inventory
     */
    static net.zestywings.ttgmod.item.inventory.ImplementedInventory ofSize(int size) {
